...
class CSActionBarSearchView(
    parent: CSActivityView<*>, viewId: Int, hint: String = "",
    var text: String = "",
    private val onChange: (String) -> Unit) : CSActivityView<SearchView>(parent,
    viewId), OnQueryTextListener, View.OnClickListener, SearchView.OnCloseListener {
    ...
    private val clearButton by lazy {
        findView<ImageView>(com.google.android.material.R.id.search_close_btn)!!
    }
